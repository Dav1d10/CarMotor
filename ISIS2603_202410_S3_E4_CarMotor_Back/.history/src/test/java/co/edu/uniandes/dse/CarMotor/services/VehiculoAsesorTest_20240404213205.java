...
public class VehiculoAsesorTest {
    ...
    private void insertData() {
        ...
        horarioTestDrive = factory.manufacturePojo(HorarioTestDriveEntity.class);
        entityManager.persist(horarioTestDrive);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            ImagenEntity entity2 = factory.manufacturePojo(ImagenEntity.class);
            entityManager.persist(entity);
            entity.getAsesor();
            entity.getHorarioTestDrive();
            vehiculoList.add(entity);
            imagenesList.add(entity2);
    ...
    @Test
    void testAddVehiculo() throws EntityNotFoundException, IllegalOperationException  {
        ...
        asesorVehiculoService.addVehiculo(newAsesor.getId(), vehiculo.getId());
        VehiculoEntity lastVehiculo = asesorVehiculoService.getVehiculo(newAsesor.getId(), vehiculo.getId());
        assertEquals(vehiculo.getId(), lastVehiculo.getId());
        assertEquals(vehiculo.getMarca(), lastVehiculo.getMarca());
        assertEquals(vehiculo.getSerie(), lastVehiculo.getSerie());
        assertEquals(vehiculo.getUltimoPlaca(), lastVehiculo.getUltimoPlaca());
        assertEquals(vehiculo.getModelo(), lastVehiculo.getModelo());
        assertEquals(vehiculo.getTipo(), lastVehiculo.getTipo());
        assertEquals(vehiculo.getCapacidad(), lastVehiculo.getCapacidad());
        assertEquals(vehiculo.getPrecio(), lastVehiculo.getPrecio());
    }
