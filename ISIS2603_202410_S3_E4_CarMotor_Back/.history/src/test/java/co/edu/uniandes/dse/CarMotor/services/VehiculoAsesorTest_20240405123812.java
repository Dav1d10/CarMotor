...
public class VehiculoAsesorTest {
    ...
    private void insertData() {
        ...
        vehiculoList.get(0).setAsesor(asesor);
	...
	void testReplaceAsesor() throws EntityNotFoundException {
        ...
        vehiculoAsesorService.replaceAsesor(asesorEntity.getId(), vehiculoList.get(0).getId());
        assertEquals(asesorEntity, vehiculoList.get(0).getAsesor());
	}
    ...
    void testRemoveAsesor() throws EntityNotFoundException {
		...
		assertTrue(!vehiculoList.get(0).getAsesor().equals(asesor));
    }
