...
public class VehiculoAsesor {
    ...
    @GetMapping(value = "/{vehiculoId}/asesores")
	@ResponseStatus(code = HttpStatus.OK)
	public List<AsesorEntity> getAsesores(@PathVariable("vehiculoId") Long asesorId) throws EntityNotFoundException {
    ...
    @DeleteMapping(value = "/{asesorId}/asesores/{vehiculoId}")
